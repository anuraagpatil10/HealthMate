          ...
          <main className="p-6">
            <div className="grid gap-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  { title: "View Schedule", description: "Check your appointments", action: "View", color: "bg-[--first]" },
                  { title: "Patient Records", description: "Access medical histories", action: "Open", color: "bg-[--second]" },
                  { title: "Write Prescription", description: "Create new prescriptions", action: "Start", color: "bg-[--first]" },
                  { title: "Lab Results", description: "Review recent lab work", action: "Review", color: "bg-[--second]" },
                ].map((item, index) => (
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {[
                          ...
                          <div key={index} className="flex items-center justify-between rounded-lg bg-white p-4">
                            <div>
